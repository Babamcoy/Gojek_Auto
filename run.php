...
echo "Pilih Mau Login Apa Daftar? \n";
echo "1. Login \n";
echo "2. Daftar \n";
...
echo "Awali dengan 62 untuk Nomer Indo dan 1 untuk nomer US\n";
echo "Masukan Nomer : ";
$nope = trim(fgets(STDIN));
$register = register($nope);
if ($register == false)
	{
	echo "Gagal Ngambil OTP, Masukin nomer yang Teregistrasi!\n";
	}
  else
	{
	...
	if ($verif == false)
		...
		{
		echo "Sedang Claim Voucher\n";
		$claim = claim($verif);
		if ($claim == false)
			{
			echo "Gagal Claim Voucher, Masukin manual aja\n";
			}
		  else
			{
			echo $claim . "\n";
